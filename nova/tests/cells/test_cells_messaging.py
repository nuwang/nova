...
class CellsTargetedMethodsTestCase(test.TestCase):
    ...
    def test_get_aggregate_list(self):
        self.mox.StubOutWithMock(self.tgt_a_api, 'get_aggregate_list')
        self.tgt_a_api.get_aggregate_list(self.ctxt).AndReturn('fake_response')
        self.mox.ReplayAll()
        response = self.src_msg_runner.get_aggregate_list(
            self.ctxt, self.tgt_cell_name)
        result = response.value_or_raise()
        self.assertEqual('fake_response', result)
...
class CellsBroadcastMethodsTestCase(test.TestCase):
    ...
    def test_security_group_rule_create(self):
        ...
        rule_out['parent_group_id'] = fake_group_id
        rule_out.pop('parent_group_name')
        ...
        self.mid_db_inst.security_group_get_by_name(self.ctxt,
                fake_group_pid, fake_group_name).AndReturn(group)
        ...
        self.src_msg_runner.security_group_rule_create(self.ctxt, group, fake_rule)
