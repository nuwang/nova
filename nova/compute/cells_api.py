...
def validate_and_split_cell(fn):
    def _wrapped(self, context, cell_and_item, *args, **kwargs):
        cell, item = self._validate_and_split_cell(cell_and_item, fn.__name__)
        return fn(self, context, (cell, item), *args, **kwargs)
    _wrapped.__name__ = fn.__name__
    return _wrapped
...
class AggregateAPI(compute_api.AggregateAPI):
    ...
    def _check_cell_and_proxy_rpcapi(self, context, method_name, cell_and_item,
                                    *args, **kwargs):
    ...
    def create_aggregate(self, context, aggregate_name, availability_zone):
        return self._check_cell_and_proxy_rpcapi(
    ...
    def get_aggregate_list(self, context, cell_name=None):
        if cell_name is not None:
            # Raise CellNotFound if cell not found
            self.db.cell_get(context, cell_name)
        return self.cells_rpcapi.get_aggregate_list(context, cell_name)
    ...
    def delete_aggregate(self, context, aggregate_id):
        self._check_cell_and_proxy_rpcapi(
